...
contract Strategy is AMMStrategyBase {
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        uint256 oneSidedProtection = continuationAligned
            ? wmul(oneSidedFlow, 1800 * BPS) + wmul(queueStress, 850 * BPS)
