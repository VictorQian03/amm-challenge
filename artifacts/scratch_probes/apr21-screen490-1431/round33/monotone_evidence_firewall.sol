...
/// @title Monotone Evidence Firewall
/// @notice Tests a one-way evidence boundary: upstream stress may add protection, never authorize fee release.
contract Strategy is AMMStrategyBase {
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        sideHazard += wmul(monotoneEvidenceFloor, 650 * BPS);
        if (sideHazard > WAD) {
            sideHazard = WAD;
        }
