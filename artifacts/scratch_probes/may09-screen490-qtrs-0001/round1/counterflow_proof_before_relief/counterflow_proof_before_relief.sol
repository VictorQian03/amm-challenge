...
/// @title Counterflow Proof Before Relief
/// @notice Requires tail clearance or post-recenter reconvergence before major relief paths spend protection.
contract Strategy is AMMStrategyBase {
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        if (reliefProof && !continuationAligned && gap >= 4) {
        ...
        if (gap >= 4) {
            ...
            if (!reliefProof && postRecenterDivergence < 3 * BPS && reconvergenceGate > 6500 * BPS) {
                reliefProof = true;
            }
        ...
        uint256 healingRebate = reliefProof ? wmul(directionalBurstFee, 2800 * BPS) : 0;
    ...
    function getName() external pure override returns (string memory) {
        return "CounterflowProofBeforeRelief";
    }
