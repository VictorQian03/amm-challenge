...
/// @title Volatility Acceleration Circuit
/// @notice Routes positive observation acceleration into a capped toxic-side pulse.
contract Strategy is AMMStrategyBase {
    ...
    function getName() external pure override returns (string memory) {
        return "VolatilityAccelerationCircuit";
    }
