...
| `active-best-raw` | May09 `FlowDirectionalRisk280` | Continue only from canonical `screen_0005` when the next idea changes the consumer contract or addresses its measured leakage/selectivity cost; do not run coefficient polish. |
